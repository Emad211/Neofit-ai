  ...
  public: {
    ...
    Functions: {
      ...
      create_workout_plan_version: {
        Args: { p_activate?: boolean; p_plan: Json; p_source?: string; p_title: string }
        Returns: { plan_id: string; plan_version: number }[]
      }
      reserve_ai_request: {
        Args: { p_burst_limit?: number; p_hourly_limit?: number; p_request_kind: string }
        Returns: {
          allowed: boolean
          burst_used: number
          hourly_used: number
