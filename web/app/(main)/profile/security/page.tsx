  ...
  return (
    <section className="page-stack" aria-labelledby="security-heading">
      ...
      <article className="profile-plan-card">
        <div><span>نشست تأییدشده</span><h3>بررسی زنده با Auth server</h3><p>برای این صفحه فقط JWT محلی کافی نیست؛ NeoFit اعتبار user را مستقیم با Supabase Auth نیز بررسی می‌کند.</p></div>
      </article>
      ...
      <form action="/auth/signout" method="post" className="signout-form">
        ...
        <button type="submit">خروج از همه نشست‌ها</button>
      </form>
    </section>
  );
}
