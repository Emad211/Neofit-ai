...
export function ProfileScreen() {
  ...
  return <section className="page-stack" aria-labelledby="profile-heading">
    ...
    <div className="profile-boundary-note"><NeoFitIcon name={account ? 'check' : 'offline'} size={18} /><p>{account ? 'Profile، Nutrition، Workout و Onboarding با Session معتبر و Policyهای مالک‌محور Supabase کار می‌کنند.' : 'در حالت مهمان، داده‌های شخصی فقط در همین مرورگر باقی می‌مانند.'}</p></div>
  </section>;
}
