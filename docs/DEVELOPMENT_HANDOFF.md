...
**Final verified branch head:** `eb0a38aa394493a546fe1003baf8c87fc4e6f0be`  
...
Final synchronized branch head:

```text
head: eb0a38aa394493a546fe1003baf8c87fc4e6f0be
Web CI 31033464760 — success
Artifact 8941648455
Digest sha256:0dcfeec0761c175cf82d2cd5f59c11d1f3be9469dca82e32e2163247172ecff7
Nutrition Core CI 31033464272 — success
Identity CI 31033463870 — success
Nutrition Persistence CI 31033463878 — success
Foundation CI 31033464269 — success
Vercel Build Contract 31033463866 — success
```
...
1. In Vercel Project Settings, configure Preview and Production:
   - `NEXT_PUBLIC_SUPABASE_URL`
   - `NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY`
2. In Supabase Auth URL Configuration, add the selected Vercel Site URL and callback/confirm-compatible Redirect URLs.
3. Wait for/reset Vercel daily deployment quota.
4. Deploy exact head `eb0a38aa394493a546fe1003baf8c87fc4e6f0be`.
5. Run a temporary real-account browser scenario:
...
6. Record Runtime evidence in `NEOFIT_AUTH_PERSISTENCE_INTEGRATION_EVIDENCE.md`.
7. Keep PR #36 Draft/unmerged until this evidence is green.
8. After Runtime proof, continue Workout Player, Onboarding and Coach with the same no-overengineering rule.
